...
class EmbeddedTableInfo:
    """A EmbeddedTableInfo object is responsible for storing any table information not stored by native dataframe

    A TableDataFrame object is a dataframe with such a EmbeddedTableInfo object attached as metadata.
    """
